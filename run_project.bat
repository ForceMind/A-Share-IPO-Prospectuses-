...
echo 2. 并行下载招股说明书 PDF 并同时进行解析 [Download and Extract]
...
echo [INFO] 正在安装或更新依赖... Installing dependencies
...
echo.
echo [INFO] 任务完成！Done!
echo [INFO] 结果文件: data/output/dividends_summary.xlsx
echo [INFO] 状态报告: data/output/status_report.csv
pause
