...
def test_downloader_batch_final(downloader, code):
    print(f"\n--- Testing Final Batch Strategy for {code} ---")
...
if __name__ == "__main__":
    ...
    targets = ["301003", "603759", "301042", "301005", "603171", "300929"]
    
    for code in targets:
        test_downloader_batch_final(downloader, code)
